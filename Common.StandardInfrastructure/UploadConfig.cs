...
namespace Common.StandardInfrastructure
{
    public class UploadConfig : IUploadConfig
    {
        ...
        public UploadConfig(IHostingEnvironment hostingEnvironment, IHttpContextAccessor contextAccessor)
        {
            _hostingEnvironment = hostingEnvironment;
            _contextAccessor = contextAccessor;
        }
        public string SaveBase64(string imgBase64, string imgName, string folderName)
        {
            ...
            var fileFullName = $"{imgName}-{Guid.NewGuid()}{fileExtension}";
        ...
        {
            var realyPath = $"{_hostingEnvironment.ContentRootPath}/{folderName}/{fileName}";
        ...
        {
            var pathToSave = $"{_hostingEnvironment.ContentRootPath}/{folderName}";
        ...
        {
            return folderName == null ? _hostingEnvironment.ContentRootPath : $"{_hostingEnvironment.ContentRootPath}/{folderName}";
        }
    }
