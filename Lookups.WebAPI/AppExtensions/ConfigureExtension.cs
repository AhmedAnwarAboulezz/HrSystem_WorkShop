...
namespace Lookups.WebAPI.AppExtensions
{
    /// <inheritdoc />
    public static class ConfigureExtension
    {
        ...
        private static void CreateDataBase(this IApplicationBuilder app)
        {
            try
            {
                ...
                using var context = scope.ServiceProvider.GetService<LookupsContext>();
        ...
        private static void SwaggerConfig(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint(swaggerEndPoint, "HRSystem");
                c.DocumentTitle = "HRSystem Api Documentation";
